...
//var num=active+effect+death+recover;
//var msg=name.concat(num);

//const prefix= "\x19Ethereum signed message:\n" + msg.length
//const sig1 = web3.eth.sign(msg, accounts[0])


//const privateKey="46d0ccd032a659a57ea93b63a4fbb54ae9503e00af7e447541e6229b4dbe7a3e"
//const sigobj= web3.eth.accounts.sign(msg, privateKey)
//const sig2=sigobj.signature;

//const whosigned1=web3.eth.accounts.recover(msg,sig1);
//const whosigned2=web3.eth.accounts.recover(sigobj);

        crud.methods.New_state(name,active,effect,death,recover).send({from: accounts[0]})
    .then(result => {
      $New_stateResult.innerHTML = `New State ${name} successfully created , sign=  , account = `;
